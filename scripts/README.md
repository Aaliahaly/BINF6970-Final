...
All data folders used or generated by the pipeline are hosted externally on Figshare. The Figshare links are provided in the `README.md` file inside the `data/` directory.
